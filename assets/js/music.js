...
async function generateArtUrl(num) {
    var salt = makeSalt(6);
    var authToken = md5(pass+salt);
    var json = await getAlbumData();
    var id = json["subsonic-response"]["albumList"]["album"][num]["id"];
    var url = "https://music.milnerbowellserver.xyz/rest/getCoverArt?id="+id+"&u=paddy&t="+authToken+"&s="+salt+"&v=1.16&c=bento&f=json";
    return url
}
